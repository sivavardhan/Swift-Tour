...
class ViewController: UIViewController, UITableViewDataSource, UITableViewDelegate  {
    ...
    var uiElementsList:NSArray = ["Label","Button","Text Field","Text View","Segment Controller","Slider","Scroll View","Activity Indicator","Image View","Collection View","Date Picker","Picker View","MapKIt"]
